...
export const defaultGlobal: Globals = {
  [FAMILY.BASE]: { height:800, depth:600, boardType:'Płyta 18mm', frontType:'Laminat', gaps:{...defaultGaps}, legsType:'Standard 10cm', offsetWall:30, shelves:1, hingeType:'Blum ClipTop', drawerSlide:'BLUM LEGRABOX', aventosType:'Brak' },
  [FAMILY.WALL]: { height:720, depth:320, boardType:'Płyta 18mm', frontType:'Laminat', gaps:{...defaultGaps}, hangerType:'Standard', offsetWall:20, shelves:1, hingeType:'Blum ClipTop', drawerSlide:'BLUM LEGRABOX', aventosType:'Brak' },
  [FAMILY.PAWLACZ]: { height:400, depth:600, boardType:'Płyta 18mm', frontType:'Laminat', gaps:{...defaultGaps}, hangerType:'Wzmocnione', offsetWall:30, shelves:1, hingeType:'Blum ClipTop', drawerSlide:'BLUM LEGRABOX', aventosType:'Brak' },
  [FAMILY.TALL]: { height:2100, depth:600, boardType:'Płyta 18mm', frontType:'Laminat', gaps:{...defaultGaps}, shelves:4, hingeType:'Blum ClipTop', drawerSlide:'BLUM LEGRABOX', aventosType:'Brak' }
}
...
type Module3D = {
  ...
  adv?: { height?:number; depth?:number; boardType?:string; frontType?:string; gaps?: Gaps; drawerFronts?: number[]; shelves?:number; hingeType?:string; drawerSlide?:string; aventosType?:string }
    /**
